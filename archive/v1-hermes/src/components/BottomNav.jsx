  ...
  return (
    ...
    >
      <div className="max-w-md mx-auto pointer-events-auto">
        <div className="grid grid-cols-3 items-end gap-1 px-2 py-2 bg-slate-950/80 backdrop-blur-2xl border border-white/10 rounded-full shadow-[0_20px_40px_rgba(0,0,0,0.5),_0_0_20px_rgba(34,211,238,0.1)]">
